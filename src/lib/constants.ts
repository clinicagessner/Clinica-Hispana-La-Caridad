...
export const SERVICES: Service[] = [
  ...
  },
  {
    "id": "salud-hombre",
    "slug": "salud-hombre",
    "title": "Urólogo en Español Houston: Próstata, PSA y Testosterona",
    "titleEn": "Spanish-Speaking Urologist Houston: PSA & Testosterone",
    "shortTitle": "Salud del Hombre",
    "description": "¿Buscas un urólogo que hable español en Houston? Evaluación de próstata (PSA), testosterona y síntomas urinarios. Sin cita, sin seguro, precios accesibles.",
    "descriptionEn": "Looking for a Spanish-speaking urologist in Houston? Prostate (PSA), testosterone and urinary symptom evaluation. Walk-in, no insurance needed, affordable pricing.",
    "longDescription": "La salud del hombre muchas veces se posterga. En Clínica Hispana La Caridad facilitamos los exámenes que ayudan a detectar a tiempo cambios importantes, con resultados explicados en español.\n\n**¿Qué incluye?**\n- Examen de antígeno prostático (PSA)\n- Medición del nivel de testosterona\n- Chequeo general y de signos vitales\n- Evaluación de síntomas urinarios o de energía\n- Referencia a especialista si se requiere\n\n**Por qué es importante**\nEl PSA ayuda a vigilar la salud de la próstata y la testosterona influye en la energía, el ánimo y la salud general. Un control sencillo te da tranquilidad.\n\n**¿Buscas un urólogo que hable español cerca de ti?**\nMuchos hombres nos encuentran buscando un urólogo en español en Houston. En nuestra clínica realizamos la evaluación inicial: examen de próstata (PSA), análisis de testosterona y revisión de síntomas urinarios como ardor, urgencia o levantarse de noche a orinar. Si tu caso necesita un urólogo especialista, te damos una referencia con tus resultados listos, para que llegues a esa consulta con un diagnóstico adelantado y ahorres tiempo y dinero.\n\n**¿Por qué elegir Clínica Hispana La Caridad?**\nSomos una clínica hispana y latina que te atiende 100% en español, sin cita previa y con precios accesibles, sin necesidad de seguro médico. Encuéntranos como tu centro médico cerca de ti en 5705 Fondren Rd STE 101, Houston, TX 77036, con horario de lunes a domingo de 9 AM a 9 PM. Nuestro equipo trata a cada paciente con respeto, tiempo y explicaciones claras.\n\n**Formas de pago**\nNo necesitas seguro médico. Manejamos precios accesibles y transparentes, y aceptamos efectivo y tarjetas. Pregúntanos por el costo de tu servicio antes de tu visita.\n\n**Áreas que servimos**\nAtendemos a pacientes de Houston, TX y todo el suroeste de la ciudad: Sharpstown, Gulfton, Bellaire, Westchase, Alief, Spring Branch, Meyerland y comunidades cercanas.",
    "longDescriptionEn": "Men's health is often postponed. At Clínica Hispana La Caridad we make it easy to get the exams that help catch important changes early, with results explained in Spanish.\n\n**What's included?**\n- Prostate antigen (PSA) test\n- Testosterone level measurement\n- General checkup and vital signs\n- Evaluation of urinary or energy symptoms\n- Referral to a specialist if needed\n\n**Why it matters**\nPSA helps monitor prostate health, and testosterone influences energy, mood and overall health. A simple check gives you peace of mind.\n\n**Looking for a Spanish-speaking urologist near you?**\nMany men find us while searching for a urologist who speaks Spanish in Houston. At our clinic we perform the initial evaluation: prostate (PSA) test, testosterone lab work and a review of urinary symptoms such as burning, urgency or waking up at night to urinate. If your case requires a urology specialist, we provide a referral with your results ready, so you arrive at that appointment with a head start and save time and money.\n\n**Why choose Clínica Hispana La Caridad?**\nWe are a Hispanic and Latino clinic that cares for you 100% in Spanish, with no appointment needed and affordable pricing, no insurance required. Find your medical center near you at 5705 Fondren Rd STE 101, Houston, TX 77036, open Monday through Sunday from 9 AM to 9 PM. Our team treats every patient with respect, time and clear explanations.\n\n**Payment**\nYou don't need health insurance. We offer affordable, transparent pricing and accept cash and cards. Ask us about the cost of your service before your visit.\n\n**Areas we serve**\nWe care for patients across Houston, TX and the entire southwest side of the city: Sharpstown, Gulfton, Bellaire, Westchase, Alief, Spring Branch, Meyerland and nearby communities.",
    "icon": "Activity",
    "image": "/images/services/salud-hombre.webp",
    "category": "medicina-general",
    "keywords": [
      "urologo en español houston",
      "urologos cerca de mi que hablen español",
      "urólogos hispanos houston",
    ...
    "keywordsEn": [
      ...
      "spanish speaking urologist near me",
      "mens health houston",
      "psa test houston",
