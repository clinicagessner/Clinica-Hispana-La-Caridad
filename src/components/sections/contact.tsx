...
export async function Contact() {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-cyan-warm">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          <div className="animate-on-scroll fade-right stagger-2 order-1 lg:order-2">
            <div className="relative bg-linear-to-br from-blue-primary via-blue-dark to-slate-dark text-white rounded-2xl p-6 md:p-8 h-full overflow-hidden">
