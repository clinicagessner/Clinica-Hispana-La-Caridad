          ...
          <div className="animate-on-scroll fade-right stagger-2 lg:col-span-2 flex flex-col gap-4">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              <div className="flex items-start gap-4 mb-5">
                <div className="size-12 rounded-xl bg-blue-primary flex items-center justify-center shrink-0">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  asChild
                  size="default"
                  className="flex-1 gap-2 bg-blue-primary text-white hover:bg-blue-dark border-0"
                >
            ...
            <div className="grid grid-cols-2 gap-3">
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <div className="size-10 rounded-lg bg-blue-primary/20 flex items-center justify-center shrink-0">
                      <IconComponent
                        className="size-5 text-blue-light"
                        weight="fill"
                      />
                    </div>
